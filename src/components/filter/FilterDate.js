...
import { setSearchOrigin, setSearchScale } from "../../redux/actions/search";
...
const FilterDate = () => {
  ...
  const getDays = () => {
    let minDate = new Date(tMin.current);
    let maxDate = new Date(tMax.current);
    return Math.floor(
